...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='/train2017/')#/data/public/rw/coco/
    ...
    parser.add_argument('--datapath', type=str, default='/annotations/') #/data/public/rw/coco/annotations
