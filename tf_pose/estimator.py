...
class TfPoseEstimator:
    ...
    def inference(self, npimg, boxes, classes, scores, resize_to_default=True, upsample_size=1.0):
        image_h, image_w = npimg.shape[:2]
        if npimg is None:
        ...
        t = time.time()
        humans = PoseEstimator.estimate_paf(peaks, self.heatMat, self.pafMat, image_h, image_w, boxes, classes, scores)
