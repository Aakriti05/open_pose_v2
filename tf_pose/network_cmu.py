...
class CmuNetwork(network_base.BaseNetwork):
    def setup(self):
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_1_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv1_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_1_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv1_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_1_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv1_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_1_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv1_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_1_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv1_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_1_6')
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_2_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv2_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_2_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv2_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_2_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv2_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_2_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv2_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_2_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv2_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_2_6')
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_3_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv3_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_3_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv3_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_3_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv3_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_3_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv3_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_3_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv3_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_3_6')
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_4_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv4_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_4_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv4_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_4_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv4_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_4_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv4_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_4_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv4_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_4_6')
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_5_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv5_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_5_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv5_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_5_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv5_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_5_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv5_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_5_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv5_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_5_6')
        ...
        (self.feed('image')
            ...
            .max_pool2d([2, 2], padding='SAME', name='pool2_6_1')
            .conv2d_fixed_padding(16*pow(2,1), 3, name='yolo_conv6_2')
            .max_pool2d([2, 2], padding='SAME', name='pool2_6_2')
            .conv2d_fixed_padding(16*pow(2,2), 3, name='yolo_conv6_3')
            .max_pool2d([2, 2], padding='SAME', name='pool2_6_3')
            .conv2d_fixed_padding(16*pow(2,3), 3, name='yolo_conv6_4')
            .max_pool2d([2, 2], padding='SAME', name='pool2_6_4')
            .conv2d_fixed_padding(16*pow(2,4), 3, name='yolo_conv6_5')
            .max_pool2d([2, 2], padding='SAME', name='pool2_6_5')
            .conv2d_fixed_padding(16*pow(2,5), 3, name='yolo_conv6_6')
            .max_pool2d([2, 2], stride=1, padding='SAME', name='pool2_6_6')
